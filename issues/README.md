...
| [040](040-sysid-must-be-assigned.md) | **sysid 由系統指派＋入列驗證協定**：驗證完成前不得指派任務或控制。設計已交付（`doc/drone-admission-protocol.md`），**四條待裁** | **high** | needs-decision | `mavlink_rx.py`＋`command`＋`drones` 表＋uav-agent |
