...
const TABS = [
  ...
  // 資訊＝疊起來的紀錄（三層）。**第五頁**：原本「四頁，不多了」是 08-04 的
  // 定案，而這一頁回答的是四頁都答不了的問題——「上禮拜那趟到底發生什麼事、
  // 那些資料我還拿得到嗎」。2026-09-07 從「錄製」擴充：檔案只是歷史的一種，
  // 架次、事件、指令都在同一頁（見 app/info/page.tsx）
  { href: "/info", label: "資訊",
    icon: ic(<><path d="M3 7.5l9-4.5 9 4.5-9 4.5-9-4.5z" /><path d="M3 12l9 4.5 9-4.5" /><path d="M3 16.5l9 4.5 9-4.5" /></>) },
];
