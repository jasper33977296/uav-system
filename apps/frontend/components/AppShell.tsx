...
const TABS = [
  ...
  // 錄製＝磁帶（兩個捲軸）。**第五頁**：原本「四頁，不多了」是 08-04 的定案，
  // 而這一頁回答的是四頁都答不了的問題——「這趟飛的資料，我拿得到嗎」。
  // 併進 /drones 的代價是它會被埋在機隊管理底下，而它是飛完當下最急的問題
  { href: "/captures", label: "錄製",
    icon: ic(<><rect x="2.5" y="6" width="19" height="12" rx="2.5" /><circle cx="8" cy="12" r="2.4" /><circle cx="16" cy="12" r="2.4" /><path d="M8 16.5h8" /></>) },
];
